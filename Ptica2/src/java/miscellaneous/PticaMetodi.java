...
public class PticaMetodi {
    ...
    // dekoder: kada korisnik unese srpska slova vršim dekodiranje, inače su srpska slova zamenjena latiničnim slovima
    // str: string koji se dekodira
    public static String dekoder(String str) throws Exception {
        String lString, dString; // lString je string levo od %, a dString je desno od %
        int indProc = -1; // indeks procenta
        ...
        if (duzStr == 1) {
            if (!(str.equalsIgnoreCase("%"))) { // ako je string dužine 1, i nije % 
