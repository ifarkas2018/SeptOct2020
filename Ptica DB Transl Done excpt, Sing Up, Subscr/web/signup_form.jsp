            ...
            function postaviVr() {   
                ...
                for (i = 0; i < INPUT_POLJA; i++) {
                    ...
                    if ((i===0) && (vrKolacica === "false" )){ 
                        document.getElementById("adm_da").checked = true; // inicijalno je postavljeno radio dugme Da 
                    }
                            ...
                            <div class="col">
                                ...
                                <form name="novi_nalog" id="novi_nalog" action="SignUpServlet" onsubmit="return proveriF();" method="post">                                   
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-sm" name="ime" id="ime" maxlength="20" onfocusout="napraviKolacic(); slova(document.novi_nalog.ime, fname_message, 'ime', false, 'false');" value="<%= input1 %>"> 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-sm" name="prezime" id="prezime"  maxlength="20" onfocusout="napraviKolacic(); slova(document.novi_nalog.prezime, lname_message, 'prezime', false, 'false');" value="<%= input2 %>"> 
