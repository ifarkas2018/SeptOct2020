...
<html>
    ...
    <body onload="postaviVr()">
        <%
            final String IME_STRANICE = "add_page.jsp"; // stranica koja se sada prikazuje
            HttpSession hSesija = PticaMetodi.vratiSesiju(request);
            hSesija.setAttribute("ime_vebstr", "add_page.jsp"); 
                    ...
                    <div class="container"> 
                        <div class="row"> 
                            <div class="col">
                                ...
                                <form id="dod_knjigu" name="dod_knjigu" action="AddServlet" method="post" onsubmit="return proveriF();">
