...
<%  final String URL_ZAP_ADM = "ptica/zaposleni"; // URL za zaposlene i administratore
    final String URL_KUP = "ptica"; // URL za kupce
%>
...
<html lang="en">
    ...
    <body class="sivapoz"> <!-- sivapoz - klasa koja postavlja sivu pozadinu ( templatecss.css ) -->
        <div class="container">
                                ...
                                %>
                                        ...
                                        <li class="nav-item dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                                ...
                                                <a class="dropdown-item" href="AddSessVar" onclick="kolacicPopunjeno('add_page.jsp')">Nova knjiga</a>  
                                                <a class="dropdown-item" href="AddSessVar" onclick="kolacicPopunjeno('update_prev.jsp')">Ažuriranje knjige</a>  
                                                <a class="dropdown-item" href="AddSessVar" onclick="kolacicPopunjeno('delete_title.jsp')">Brisanje knjige</a>  
                                            </div>
                                        </li>
                                <%
                                    }
